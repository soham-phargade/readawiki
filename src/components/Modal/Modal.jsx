    ...
    <Popup open={open} closeOnDocumentClick onClose={closeModal}>
      <div className={`modal ${isSidebarOpen ? 'with-sidebar' : ''}`}>
        ...
        <p>
          ...
          keyword scoring. This allowed us to rank pages based on relevance, not SEO tricks, and we complimented this tool with a minimalist web browser that helps academics zone in on their research.<br></br><br></br>
          We indexed about 300,000 pages, all relating to US politics and Computer Science. Searches about these topics will yield better results.
        </p>
      </div>
    </Popup>
  );
